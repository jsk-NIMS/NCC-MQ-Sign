...
extern void asm_ntt_5_radix3(int32_t * Out, int32_t* zeta); //2
...
extern void asm_intt_5(int32_t * Out, int32_t* zeta); //2-3-3
extern void asm_intt_5_radix3(int32_t * Out, int32_t* zeta); //2
