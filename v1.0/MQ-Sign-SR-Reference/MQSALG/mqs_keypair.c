...
static
void _generate_sk_mqsr(sk_mqsr* sk, const unsigned char* sk_seed)
{
...
int generate_keypair_mqsr(pk_mqs* rpk, sk_mqsr* sk, const unsigned char* sk_seed)
{
	_generate_sk_mqsr(sk, sk_seed);
